...
SetTitleMatchMode 2
id:=WinExist("Roblox ahk_class WINDOWSCLIENT")
FindText().BindWindow(id)  ; Unbind Window using FindText().BindWindow(0)
...
if (ok:=FindText(&X, &Y, 1325-150000, 313-150000, 1325+150000, 313+150000, 0, 0, Text))
{
